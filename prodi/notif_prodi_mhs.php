        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            Notifikasi masuk dari Mahasiswa
                        </h2>
                        <p></p>
                            ...
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Jurusan</th>
                                        <th>Tanggal Penginputan Mahasiswa</th>
                                ...
                                <tbody>
                                    ...
                                    <?php $ambil = $koneksi->query("SELECT * from acc where view=1"); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group-vertical">
                                                    <a href="?page=detail_prodi_mhs&ke=<?= $data['id_acc']; ?>" class="btn btn-info btn-sm"> Perbaharui</a>
                                                </div>
                                            </td>
