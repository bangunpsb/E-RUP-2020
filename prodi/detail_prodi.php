                ...
                <div class="card">
                    <div class="header">
                        ...
                        <form action="?page=prodi_proses" method="post">
                            ...
                            <label for="tgl_prodi">Tanggal pengiriman ke baak </label>
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="date" id="tgl_prodi" name="tgl_prodi" value="<?= $today; ?>" class="form-control" autofocus required>
                                </div>
                            </div>

                            <label for="pembimbing">Nama Pembimbing </label>
                            <div class="form-group">
                                <select name="nama_pembimbing" id="pembimbing" class="form-control show-tick" data-live-search="true" required>
                                    <option value="" disabled selected> Pilih Nama Pembimbing</option>
                                    <?php $result = mysqli_query($koneksi, "SELECT * FROM user where level='lppm'or level='prodi' or level='reviewer'"); ?>
                            ...
                            <br>
                            <button type="submit" class="btn btn-primary m-t-15 waves-effect" name="kirim_prodi">Perbaharui</button>
                        </form>
