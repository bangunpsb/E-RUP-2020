...
<section class="content">
    <div class="container-fluid">
        ...
        <!-- jumlah notif prodi dari baak -->
        <?php $sql = $koneksi->query("SELECT COUNT(nim_mhs) as jumlah from rkpp where view='6'"); ?>
        <?php while ($data = $sql->fetch_assoc()) { ?>
            <?php $prodi = $data['jumlah']; ?>
        <?php } ?>


        <!-- jumlah notif prodi dari mahasiswa yang mengirim proposal -->
        <?php $sql = $koneksi->query("SELECT COUNT(id_acc) as mhs from acc where view='1'"); ?>
        <?php while ($data = $sql->fetch_assoc()) { ?>
            <?php $mahasiswa = $data['mhs']; ?>
        <?php } ?>

        <p></p>
        <!-- Widgets -->
        <div class="row clearfix">
            <a href="?page=notif_prodi">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-pink hover-expand-effect">
                        ...
                        <div class="content">
                            ...
                            <div class="number count-to" data-from="0" data-to="125" data-speed="15" data-fresh-interval="20"><?= $prodi; ?></div>
                        </div>
                    </div>
                </div>
            </a>
            <a href="?page=notif_prodi_mhs">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-green hover-expand-effect">
                        ...
                        <div class="content">
                            ...
                            <div class="number count-to" data-from="0" data-to="125" data-speed="15" data-fresh-interval="20"><?= $mahasiswa; ?></div>
                        </div>
                    </div>
                </div>
            </a>
