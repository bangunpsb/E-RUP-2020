...
<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2>Notifikasi sebagai Reviewer</h2>
        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <tbody>
                                    ...
                                    <?php $ambil = $koneksi->query("SELECT * from rkpp where nama_reviewer='$nama' and view=4"); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group-vertical">
                                                    <a href="?page=detail_baak_asreviewer&ke=<?= $data['id_rkp']; ?>" class="btn btn-info btn-sm"> Perbaharui</a>
                                                </div>
                                            </td>
