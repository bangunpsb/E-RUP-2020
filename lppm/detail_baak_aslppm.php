            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        ...
                        <p></p>
                        <center>
                            <p class="text-danger">NOTE : <b> <u> JIKA RUP DITOLAK MAKA NAMA REVIEWER DIKOSONGKAN SAJA</u></b></p>
                        </center>

                        <p></p>
                        <form action="?page=lppm_proses" method="post">
                            <label for="baak">Nama LPPM</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <?php $nama = $_SESSION['nama']; ?>
                                    <input type="text" id="baak" value="<?= $nama; ?>" name="nama_lppm" class="form-control" placeholder="Masukan nama reviewer" required>
                                </div>
                            </div>
                            ...
                            <label for="tgl_lppm">Tanggal pengiriman ke baak </label>
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="date" id="tgl_lppm" name="tgl_lppm" value="<?= $today; ?>" class="form-control" autofocus required>
                                </div>
                            </div>

                            <label for="st_lppm">Status RUP Mahasiswa </label>
                            <div class="form-group">
                                <select name="st_lppm" id="st_lppm" class="form-control show-tick" data-live-search="true" required>
                            ...
                            <div class="form-group">
                                <select name="nama_reviewer" id="reviewer" class="form-control show-tick" data-live-search="true">
                                    <option value="" disabled selected> Pilih Reviewer</option>
                                    <?php $result = mysqli_query($koneksi, "SELECT * FROM user where level='lppm' or level='reviewer'"); ?>
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <textarea rows="3" id="alp" name="komentar_lppm" class="form-control no-resize" placeholder="Jelaskan alasannya..." required></textarea>
                                </div>
                            </div>

                            <input type="hidden" name="id_rkp" value="<?= $data['id_rkp'] ?>">
                            <br>
                            <button type="submit" class="btn btn-primary m-t-15 waves-effect" name="kirim_baak_aslppm">Perbaharui</button>
                        </form>
