        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            Notifikasi masuk dari Reviewer
                        </h2>
                        <p></p>
                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <tbody>
                                    <?php $ambil = $koneksi->query("SELECT * from rkpp where view=5"); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group-vertical">
                                                    <a href="?page=detail_reviewer&ke=<?= $data['id_rkp']; ?>" class="btn btn-info btn-sm"> Perbaharui</a>
                                                </div>
                                            </td>
