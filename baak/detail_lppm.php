                 ...
                 <div class="card">
                     <div class="header">
                         ...
                         <p> <b style="color:black"> Note : </b>Jika status mahasiswa <b style="color:red"><u> Ditolak</u></b> kirim ke <b> Mahasiswa </b><br>
                             <span style="margin-left:3.3vw"> Jika status mahasiswa <b style="color:red"> <u> Diterima</u></b> kirim ke <b> Nama Reviewer</b></span>
                         </p>

                     </div>
                     <div class="body">
                         <center>
                             Status Mahasiswa dinyatakan : <span class="text-danger "><b><?= $data['st_lppm']; ?></b></span>
                             <p></p>
                             Nama Reviewer : <span class="text-danger"> <b> <?= $data['nama_reviewer']; ?></b></span>
                         </center>
                         <hr>

                         <h5 class="text-red">Profile baak :</h5>
                         ...
                         <form action="?page=baak_proses" method="post">
                             ...
                             <div class="form-group">
                                 <div class="form-line">
                                     ...
                                     <input type="text" id="baak" name="nama_baakk" value="<?= $nama; ?>" class="form-control" placeholder="Masukan nama baak" required>
                                 </div>
                             </div>
                             <?php
                                $month = date('m');
                             ...
                             <label for="tglp_baak">Tanggal penyerahan rup ke penelaah </label>
                             <div class="form-group">
                                 <div class="form-line">
                                     <input type="date" id="tgl_baakk" name="tgl_baakk" class="form-control" value="<?= $today; ?>" autofocus required>
                                 </div>
                             </div>

                             <label for="nama_reviewer">Kirim ke </label>
                             <div class="form-group">
                                 <select name="nama_reviewer" id="" class="form-control show-tick" data-live-search="true" required>
                             ...
                             <br>
                             <button type="submit" class="btn btn-primary m-t-15 waves-effect" name="kirim_notif_lppm">Perbaharui</button>
                         </form>
