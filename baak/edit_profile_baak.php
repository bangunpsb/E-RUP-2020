            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <div class="row clearfix">
                            <form action="?page=baak_proses" method="post" enctype="multipart/form-data">
                                <div class="col-md-4">
                                ...
                                <div class="button-demo">
                                    <button type="submit" class="btn btn-success" name="editbaak" style="margin-left:3vw;margin-top:5px;">Edit</button>
                                </div>
