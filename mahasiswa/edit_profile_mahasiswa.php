                            ...
                            <form action="?page=mahasiswa_proses" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group">
                                        ...
                                        <div class="form-line">
                                            <input type="text" class="form-control date" name="password" placeholder="New Password">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="button-demo">
                                    <button type="submit" class="btn btn-success" name="editmhs" style="margin-left:3vw;margin-top:5px;">Edit</button>
                                </div>
